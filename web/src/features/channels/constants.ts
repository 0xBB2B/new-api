...
export const CHANNEL_TYPES = {
  ...
  58: 'Advanced Custom',
  59: 'Sub2API',
  60: 'Claude Subscription',
} as const

const CHANNEL_TYPE_DISPLAY_ORDER: number[] = [
  1, 14, 60, 33, 24, 43, 3, 41, 48, 58, 42, 34, 20, 4, 40, 27, 25, 17, 26, 15,
...
export const TYPE_TO_KEY_PROMPT: Record<number, string> = {
  ...
  60: 'Paste Claude Code OAuth JSON credential (claudeAiOauth with accessToken / refreshToken)',
}
