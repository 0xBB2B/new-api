...
description: 上游 /v1/messages,复用标准 Claude 请求转换与 token 计费;无固定订阅倍率;不提供面向终端用户的用量展示。
---

# 请求转换、计费与非目标

## 目的
明确 Claude 订阅渠道复用标准 Claude 管道处理请求与计费,并划定「不向终端用户做用量展示」的边界。
